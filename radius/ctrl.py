...
exec_shell("tc class add dev "+ODEV+" parent 10: classid 10:1 htb rate "+UP+" ceil "+UP)
exec_shell("tc class add dev "+IDEV+" parent 10: classid 10:1 htb rate "+DOWN+" ceil "+DOWN)
